...
export default function MoviesPage() {
  ...
  return (
    <Layout>
      <Head>
        <title>Browse Movies — MovieNest</title>
        <meta name="description" content="Browse and discover movies on MovieNest." />
      </Head>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-24 min-h-[80vh]">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-8">Movies</h1>
        ...
        {isError ? (
          <ErrorState message="Failed to load movies. Please try again later." onRetry={() => refetch()} />
